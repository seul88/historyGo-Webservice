...
<html>
    ...
    <body style="background-color: aliceblue">
        ...
        <div class="jumbotron text-center">  <h1 class="display-1"> Użytkownicy </h1>
        </div>
                                        ...
                                        <td> <b> <c:out value="${player.name}" />  </b> </td>
                                         ...
                                         <td>
                                             ...
                                             <form action="delete" method="post">
                                                 <input type = "hidden" name="name" value="${player.name}"> <input type="submit" class="btn btn-danger m-1 pl-5 pr-5" value="USUŃ">
                                             </form>
                                         </td>
                                    </tr>
